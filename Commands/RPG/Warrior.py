...
class Warrior(commands.Cog):
    ...
    async def warrior(self, ctx, *args):
        ...
        await ctx.send("**__Crush (Lvl 1)__**: 20 Damage 20% Chance to Stun (Cooldown: 3 Turns)")
    ...
    async def warrior_loot_table(self, ctx):
        ...
        await ctx.send("🟩 Good Boots of Asskicking (+10 Health)")
        await ctx.send("🟦 Rare Boots of Asskicking (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Boots of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Boots of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Legs**")
        await ctx.send("Shitty Greaves")
        await ctx.send("🟩 Good Greaves of Asskicking (+10 Health)")
        await ctx.send("🟦 Rare Greaves of Asskicking (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Greaves of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Greaves of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Chest**")
        await ctx.send("Shitty Chestplate")
        await ctx.send("🟩 Good Chestplate of Asskicking (+10 Health)")
        await ctx.send("🟦 Rare Chestplate of Asskicking (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Chestplate of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Chestplate of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Gloves**")
        await ctx.send("Shitty Gauntlets")
        await ctx.send("🟩 Good Gauntlets of Asskicking (+10 Health)")
        await ctx.send("🟦 Rare Gauntlets of Asskicking (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Gauntlets of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Gauntlets of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Helmet**")
        await ctx.send("Shitty Helmet")
        await ctx.send("🟩 Good Helmet of Asskicking (+10 Health)")
        await ctx.send("🟦 Rare Helmet of Asskicking (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Helmet of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Helmet of Asskicking (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
