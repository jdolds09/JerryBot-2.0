...
class Rpg(commands.Cog):
    ...
    async def rpg(self, ctx):
        ...
        await ctx.send("-------------------------------------------------")
        await ctx.send("**!pvp** - Enters the PVP arena, when two players use this command, the PVP duel begins.")
        await ctx.send("**!pvp cast** - Casts a basic attack in the PVP arena. !pvp attack or !pvp spell also works.")
        await ctx.send("**!pvp cast [spell]** - Cast a spell/ability during a PVP duel. ![enter your class here] loot to see a list of your class's spells.")
        await ctx.send("-------------------------------------------------")
