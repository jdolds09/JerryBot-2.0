...
class Gambler(commands.Cog):
    ...
    async def gambler_loot_table(self, ctx):
        ...
        await ctx.send("🟩 Good Boots of Luck (+10 Health)")
        await ctx.send("🟦 Rare Boots of Luck (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Boots of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Boots of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Legs**")
        await ctx.send("Shitty Pants")
        await ctx.send("🟩 Good Pants of Luck (+10 Health)")
        await ctx.send("🟦 Rare Pants of Luck (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Pants of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Pants of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Chest**")
        await ctx.send("Shitty Jacket")
        await ctx.send("🟩 Good Jacket of Luck (+10 Health)")
        await ctx.send("🟦 Rare Jacket of Luck (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Jacket of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Jacket of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Gloves**")
        await ctx.send("Shitty Gloves")
        await ctx.send("🟩 Good Gloves of Luck (+10 Health)")
        await ctx.send("🟦 Rare Gloves of Luck (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Gloves of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Gloves of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Helmet**")
        await ctx.send("Shitty Fedora")
        await ctx.send("🟩 Good Fedora of Luck (+10 Health)")
        await ctx.send("🟦 Rare Fedora of Luck (+10 Health, +1% Dodge & Block)")
        await ctx.send("🟪 Epic Fedora of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance)")
        await ctx.send("🟨 Legendary Fedora of Luck (+10 Health, +1% Dodge & Block, +1% Crit Chance, +1% hit chance)")
        await ctx.send("**Main Hand Weapon**")
        await ctx.send("Shitty Trinket")
        await ctx.send("🟩 Good Trinket of Luck (+5 Damage)")
        await ctx.send("🟦 Rare Trinket of Luck (+10 Damage)")
        await ctx.send("🟪 Epic Trinket of Luck (+15 Damage,)")
        await ctx.send("🟨 Legendary Trinket of Luck (+20 Damage)")
        await ctx.send("**Off Hand**")
        await ctx.send("Shitty Charm")
        await ctx.send("🟩 Good Charm of Luck (+1% Block Chance)")
        await ctx.send("🟦 Rare Charm of Luck (+3% Block Chance)")
        await ctx.send("🟪 Epic Charm of Luck (+5% Block Chance)")
        await ctx.send("🟨 Legendary Charm of Luck (+10% Block Chance)")
async def setup(bot):
