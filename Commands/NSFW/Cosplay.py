...
class Cosplay(commands.Cog):
    ...
    async def cosplay(self, ctx):
        ...
        subreddits = [
            "cosplaygirls", "cosplay", "cosplaybabes", "CosplayLewd", "nsfwcosplay",
            "geekygirls", "cosplaybutts", "suicidegirls"
        ]
    ...
    async def command_help(self, ctx):
        await ctx.send("**!cosplay**: Posts a cosplay pic/gif.")

async def setup(bot):
    await bot.add_cog(Cosplay(bot))